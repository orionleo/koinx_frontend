    ...
    return (
        <div className='w-full hidden sm:flex flex-col text-white bg-black'>
            ...
            <div className='w-full p-3 flex justify-between px-20 text-left  space-x-10'>
                <div className='flex flex-col w-full justify-start items-center text-left space-y-3'>
                ...
                <div className='flex flex-col w-full justify-start items-center text-left space-y-3'>
                    ...
                    <div className='text-[15px] text-left font-normal flex gap-x-2'>Careers <div className='bg-[#2997F9]/50 p-1'>{"We're Hiring"}</div> </div >
